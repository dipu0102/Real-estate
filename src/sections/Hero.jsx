    ...
    <>
      <div className={`${darkMode ? "dark bg-black" : "light bg-white"}`}>
        ...
        >
          <h1
            data-aos="zoom-in"
            className="text-6xl text-white font-semibold lg:pr-[600px] pr-0 lg:leading-[70px]
          leading-[60px]"
          >
          ...
          >
            ...
            tempora animi pariatur debitis odio aut sunt sequi non quis magnam!
          </p>
        </section>
      </div>
        ...
        >
          <div className="w-full">
            ...
            <input
              ...
              className="bg-white p-2 w-full mt-2 border-b-[1px] border-[#c9c7c1] outline-none"
            />
          </div>
          <div className="w-full">
            ...
            <select
              name="selectOption"
              id="selectOption"
              className="bg-white p-2 border-b-[1px] w-full border-[#c9c7c1] text-gray-500 text-md"
            >
